      ...
      <div className="footer-main">
        ...
        <div className="footer-icons">
          <span
            onClick={() =>
              (window.location.href =
                "https://www.instagram.com/jeremyrenner?igsh=dWpjMGdkbjFxNzcx")
            }
          >
            <FaInstagram />
          </span>
          ...
          <span
            onClick={() =>
              (window.location.href =
                "https://www.facebook.com/share/1G7dbB4nSQ/?mibextid=wwXIfr")
            }
          >
            <FaFacebook />
          </span>
          ...
          <span
            onClick={() =>
              (window.location.href = "https://x.com/jeremyrenner?s=21")
            }
          >
            <FaXTwitter />
          </span>
